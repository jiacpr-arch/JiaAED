...
export const NEWS_QUERIES = [
  ...
  "เครื่อง AED ห้างสรรพสินค้า สนามบิน สถานีรถไฟฟ้า",
  "ฟิตเนส ออกกำลังกาย หัวใจวายเฉียบพลัน",
];
...
- blurb: ไทย 1-2 ประโยค ยาวประมาณ 70-160 ตัวอักษร — เปิดด้วยใจความข่าวสั้น ๆ แล้วเชื่อมโยงว่าทำไมการรู้วิธี CPR หรือมีเครื่อง AED พร้อมใช้ใกล้ตัวจึงสำคัญ โทนกระชับ ชวนอ่าน ให้ความรู้ ไม่ขายตรง
- ห้ามเอ่ยชื่อบุคคลในข่าวเพื่อหาประโยชน์ ห้ามใส่ร้ายหรือตัดสินอาการของใคร
