...
export const acquisitionPackages: AcquisitionPackage[] = [
  ...
  },
  {
    ...
    priceLabel: "฿3,000/เดือน",
    listPriceLabel: null,
    // Rent-to-own total = 20,000 + 3,000 × 18 = ฿74,000. สัดส่วนพรีเมียมเทียบราคาสด
    // (74,000 / 52,900 ≈ 1.40) เท่ากับสัดส่วนของแพ็ก pkg-start เดิม (60,000/42,900 ≈ 1.40)
    // — คงความสม่ำเสมอของนโยบายผ่อนระหว่างรุ่น.
    priceNote: "มัดจำ ฿20,000 + ผ่อน ฿3,000/เดือน × 18 เดือน แล้วเป็นเจ้าของ",
    deposit: "฿20,000 (นับเป็นส่วนหนึ่งของค่าเครื่อง)",
    features: [
