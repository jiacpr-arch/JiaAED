...
export function QuickContact() {
  ...
  return (
    <div className="quick-contact-panel rounded-2xl border border-[#06C755]/30 bg-gradient-to-br from-[#06C755]/10 to-transparent p-5 md:p-6">
      <div className="quick-contact-copy text-center mb-4">
      ...
      <div className="quick-contact-actions">
        ...
        <a
          ...
          className="block text-center border border-gray-600 hover:border-yellow-400 text-white font-bold text-base px-8 py-3 rounded-full transition-colors"
        >
          📞 โทร {PHONE_DISPLAY}
        </a>
      </div>
